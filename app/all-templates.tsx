...
export default function AllTemplatesScreen() {
  ...
  const allTemplates = useMemo(() => {
    return [...userTemplates.filter(t => !t.isArchived), ...PRESET_TEMPLATES];
  }, [userTemplates]);
      ...
      <View style={styles.cardContent}>
        <View style={styles.cardHeader}>
          ...
          <View style={styles.headerInfo}>
            ...
            <ThemedText type="label" size={10} color={Colors.onSurfaceVariant} style={[styles.trackingWidest, { marginBottom: 2 }]}>
              {item.isPreset ? 'EXAMPLE' : 'MY TEMPLATE'}
            </ThemedText>
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText type="headline" size={24}>Workouts</ThemedText>
          <TouchableOpacity 
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <MaterialCommunityIcons name="clipboard-text-search-outline" size={64} color={Colors.surfaceVariant} />
