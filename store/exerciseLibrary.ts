...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { id: 'chest_009', name: 'Cable Crossover',               category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Chest' },
  { id: 'chest_010', name: 'Low Cable Fly',                 category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Chest' },
  { id: 'chest_011', name: 'High Cable Fly',                category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Chest' },
  { id: 'chest_012', name: 'Chest Press Machine',           category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Chest' },
  { id: 'chest_013', name: 'Pec Deck Fly',                  category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Chest' },
  ...
  { id: 'chest_017', name: 'Around the World',              category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Chest' },
  { id: 'chest_018', name: 'Svend Press',                   category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Chest' },
  ...
  { id: 'back_003',  name: 'Barbell Row',                   category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_004',  name: 'Pendlay Row',                   category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_005',  name: 'T-Bar Row',                     category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  ...
  { id: 'back_009',  name: 'Lat Pulldown',                  category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_010',  name: 'Close-Grip Lat Pulldown',       category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_011',  name: 'Seated Cable Row',              category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_012',  name: 'Close-Grip Seated Cable Row',   category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  ...
  { id: 'back_015',  name: 'Back Extension',                category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_016',  name: 'Back Extension (Machine)',      category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_017',  name: 'Good Morning',                  category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_018',  name: 'Face Pull',                     category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },
  { id: 'back_019',  name: 'Straight-Arm Pulldown',         category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Back' },

  // ── SHOULDERS ──────────────────────────────
  { id: 'sho_001',   name: 'Overhead Press',                category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  ...
  { id: 'sho_008',   name: 'Reverse Pec Deck',              category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  ...
  { id: 'sho_011',   name: 'Barbell Upright Row',           category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  { id: 'sho_012',   name: 'Cable Upright Row',             category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  { id: 'sho_013',   name: 'Handstand Push-up',             category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  { id: 'sho_014',   name: 'Dumbbell Shrug',                category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Shoulders' },
  { id: 'sho_015',   name: 'Barbell Shrug',                 category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Shoulders' },

  // ── ARMS ───────────────────────────────────
  { id: 'arm_001',   name: 'Barbell Curl',                  category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_002',   name: 'EZ-Bar Curl',                   category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_003',   name: 'Dumbbell Curl',                 category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Arms' },
  ...
  { id: 'arm_007',   name: 'Preacher Curl',                 category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_008',   name: 'Cable Curl',                    category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_009',   name: 'Machine Curl',                  category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_010',   name: 'Triceps Pushdown (Bar)',        category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_011',   name: 'Triceps Pushdown (Rope)',       category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_012',   name: 'Overhead Triceps Extension',    category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Arms' },
  { id: 'arm_013',   name: 'Skull Crushers',                category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Arms' },
  ...
  { id: 'arm_016',   name: 'Kickback',                      category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Arms' },
  ...
  { id: 'leg_006',   name: 'Leg Press',                     category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Legs' },
  { id: 'leg_007',   name: 'Leg Extension',                 category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Legs' },
  ...
  { id: 'leg_014',   name: 'Calf Raises (Standing)',        category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Legs' },
  { id: 'leg_015',   name: 'Calf Raises (Seated)',          category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Legs' },
  ...
  { id: 'leg_018',   name: 'Glute Kickback (Cable)',        category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Legs' },
  ...
  { id: 'leg_021',   name: 'Nordic Curl',                   category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Legs' },
  { id: 'leg_022',   name: 'Sissy Squat',                   category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Legs' },

  // ── CORE ───────────────────────────────────
  { id: 'core_001',  name: 'Ab Wheel',                      category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Core' },
  { id: 'core_002',  name: 'Plank',                         category: 'Duration',          exerciseType: 'duration', bodyPart: 'Core' },
  { id: 'core_003',  name: 'Side Plank',                    category: 'Duration',          exerciseType: 'duration', bodyPart: 'Core' },
  { id: 'core_004',  name: 'Crunch',                        category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Core' },
  { id: 'core_005',  name: 'Bicycle Crunch',                category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Core' },
  { id: 'core_006',  name: 'Sit-up',                        category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Core' },
  ...
  { id: 'core_009',  name: 'Cable Crunch',                  category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Core' },
  ...
  { id: 'core_012',  name: 'Pallof Press',                  category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Core' },
  { id: 'core_013',  name: 'Woodchop',                      category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Core' },
  { id: 'core_014',  name: 'Toe-to-Bar',                    category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Core' },
  { id: 'core_015',  name: 'Dragon Flag',                   category: 'Weighted Bodyweight', exerciseType: 'weight_reps', bodyPart: 'Core' },
  { id: 'core_016',  name: 'L-Sit',                         category: 'Duration',          exerciseType: 'duration', bodyPart: 'Core' },
  { id: 'core_017',  name: 'Dead Bug',                      category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Core' },
  { id: 'core_018',  name: 'Hollow Body Hold',              category: 'Duration',          exerciseType: 'duration', bodyPart: 'Core' },
  { id: 'core_019',  name: 'Landmine Rotation',             category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Core' },
  { id: 'core_020',  name: 'Ab Machine Crunch',             category: 'Machine',           exerciseType: 'weight_reps', bodyPart: 'Core' },

  // ── OLYMPIC ────────────────────────────────
  { id: 'oly_001',   name: 'Power Clean',                   category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_002',   name: 'Clean & Jerk',                  category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_003',   name: 'Snatch',                        category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_004',   name: 'Hang Clean',                    category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_005',   name: 'Push Press',                    category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_006',   name: 'Push Jerk',                     category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },
  { id: 'oly_007',   name: 'Hang Snatch',                   category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Olympic' },

  // ── FULL BODY ──────────────────────────────
  { id: 'fb_001',    name: 'Kettlebell Swing',              category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_002',    name: 'Kettlebell Turkish Get-up',     category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_003',    name: 'Battle Ropes',                  category: 'Cardio',            exerciseType: 'duration',    bodyPart: 'Full Body' },
  { id: 'fb_004',    name: 'Burpee',                        category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Full Body' },
  { id: 'fb_005',    name: 'Ball Slams',                    category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_006',    name: 'Farmer\'s Walk',                category: 'Dumbbell',          exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_007',    name: 'Sandbag Carry',                 category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_008',    name: 'Sled Push',                     category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_009',    name: 'Thrusters',                     category: 'Barbell',           exerciseType: 'weight_reps', bodyPart: 'Full Body' },
  { id: 'fb_010',    name: 'Wall Ball',                     category: 'Other',             exerciseType: 'weight_reps', bodyPart: 'Full Body' },

  // ── CARDIO ─────────────────────────────────
  { id: 'card_001',  name: 'Running (Treadmill)',           category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_002',  name: 'Running (Outdoor)',             category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_003',  name: 'Cycling (Stationary)',         category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_004',  name: 'Cycling (Outdoor)',            category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_005',  name: 'Rowing Machine',               category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_006',  name: 'Elliptical Trainer',           category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_007',  name: 'Stair Climber',                category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_008',  name: 'Jump Rope',                    category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_009',  name: 'Aerobics',                     category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_010',  name: 'Swimming',                     category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_011',  name: 'Assault Bike',                 category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
  { id: 'card_012',  name: 'Box Jump',                     category: 'Reps Only',         exerciseType: 'reps_only', bodyPart: 'Cardio' },
  ...
  { id: 'card_015',  name: 'Sprint Intervals',             category: 'Cardio',            exerciseType: 'duration', bodyPart: 'Cardio' },
];
