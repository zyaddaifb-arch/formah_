...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  // ── CHEST ──────────────────────────────────
  { id: 'chest_001', name: 'Barbell Bench Press',           category: 'Barbell',           bodyPart: 'Chest' },
  { id: 'chest_002', name: 'Incline Barbell Bench Press',   category: 'Barbell',           bodyPart: 'Chest' },
  { id: 'chest_003', name: 'Decline Barbell Bench Press',   category: 'Barbell',           bodyPart: 'Chest' },
  { id: 'chest_004', name: 'Dumbbell Bench Press',          category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_005', name: 'Incline Dumbbell Press',        category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_006', name: 'Decline Dumbbell Press',        category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_007', name: 'Dumbbell Fly',                  category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_008', name: 'Incline Dumbbell Fly',          category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_009', name: 'Cable Crossover',               category: 'Machine',           bodyPart: 'Chest' },
  { id: 'chest_010', name: 'Low Cable Fly',                 category: 'Machine',           bodyPart: 'Chest' },
  { id: 'chest_011', name: 'High Cable Fly',                category: 'Machine',           bodyPart: 'Chest' },
  { id: 'chest_012', name: 'Chest Press Machine',           category: 'Machine',           bodyPart: 'Chest' },
  { id: 'chest_013', name: 'Pec Deck Fly',                  category: 'Machine',           bodyPart: 'Chest' },
  { id: 'chest_014', name: 'Push-up',                       category: 'Weighted Bodyweight', bodyPart: 'Chest' },
  { id: 'chest_015', name: 'Wide Push-up',                  category: 'Weighted Bodyweight', bodyPart: 'Chest' },
  { id: 'chest_016', name: 'Diamond Push-up',               category: 'Weighted Bodyweight', bodyPart: 'Chest' },
  { id: 'chest_017', name: 'Around the World',              category: 'Dumbbell',          bodyPart: 'Chest' },
  { id: 'chest_018', name: 'Svend Press',                   category: 'Other',             bodyPart: 'Chest' },

  // ── BACK ───────────────────────────────────
  { id: 'back_001',  name: 'Deadlift',                      category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_002',  name: 'Romanian Deadlift',             category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_003',  name: 'Barbell Row',                   category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_004',  name: 'Pendlay Row',                   category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_005',  name: 'T-Bar Row',                     category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_006',  name: 'Pull-up',                       category: 'Weighted Bodyweight', bodyPart: 'Back' },
  { id: 'back_007',  name: 'Chin-up',                       category: 'Weighted Bodyweight', bodyPart: 'Back' },
  { id: 'back_008',  name: 'Neutral-Grip Pull-up',          category: 'Weighted Bodyweight', bodyPart: 'Back' },
  { id: 'back_009',  name: 'Lat Pulldown',                  category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_010',  name: 'Close-Grip Lat Pulldown',       category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_011',  name: 'Seated Cable Row',              category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_012',  name: 'Close-Grip Seated Cable Row',   category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_013',  name: 'Dumbbell Row',                  category: 'Dumbbell',          bodyPart: 'Back' },
  { id: 'back_014',  name: 'Incline Dumbbell Row',          category: 'Dumbbell',          bodyPart: 'Back' },
  { id: 'back_015',  name: 'Back Extension',                category: 'Weighted Bodyweight', bodyPart: 'Back' },
  { id: 'back_016',  name: 'Back Extension (Machine)',      category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_017',  name: 'Good Morning',                  category: 'Barbell',           bodyPart: 'Back' },
  { id: 'back_018',  name: 'Face Pull',                     category: 'Machine',           bodyPart: 'Back' },
  { id: 'back_019',  name: 'Straight-Arm Pulldown',         category: 'Machine',           bodyPart: 'Back' },

  // ── SHOULDERS ──────────────────────────────
  { id: 'sho_001',   name: 'Overhead Press',                category: 'Barbell',           bodyPart: 'Shoulders' },
  { id: 'sho_002',   name: 'Seated Dumbbell Press',         category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_003',   name: 'Arnold Press',                  category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_004',   name: 'Dumbbell Lateral Raise',        category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_005',   name: 'Cable Lateral Raise',           category: 'Machine',           bodyPart: 'Shoulders' },
  { id: 'sho_006',   name: 'Dumbbell Front Raise',          category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_007',   name: 'Barbell Front Raise',           category: 'Barbell',           bodyPart: 'Shoulders' },
  { id: 'sho_008',   name: 'Reverse Pec Deck',              category: 'Machine',           bodyPart: 'Shoulders' },
  { id: 'sho_009',   name: 'Dumbbell Rear Delt Fly',        category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_010',   name: 'Machine Shoulder Press',        category: 'Machine',           bodyPart: 'Shoulders' },
  { id: 'sho_011',   name: 'Barbell Upright Row',           category: 'Barbell',           bodyPart: 'Shoulders' },
  { id: 'sho_012',   name: 'Cable Upright Row',             category: 'Machine',           bodyPart: 'Shoulders' },
  { id: 'sho_013',   name: 'Handstand Push-up',             category: 'Weighted Bodyweight', bodyPart: 'Shoulders' },
  { id: 'sho_014',   name: 'Dumbbell Shrug',                category: 'Dumbbell',          bodyPart: 'Shoulders' },
  { id: 'sho_015',   name: 'Barbell Shrug',                 category: 'Barbell',           bodyPart: 'Shoulders' },

  // ── ARMS ───────────────────────────────────
  { id: 'arm_001',   name: 'Barbell Curl',                  category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_002',   name: 'EZ-Bar Curl',                   category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_003',   name: 'Dumbbell Curl',                 category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_004',   name: 'Hammer Curl',                   category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_005',   name: 'Incline Dumbbell Curl',         category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_006',   name: 'Concentration Curl',            category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_007',   name: 'Preacher Curl',                 category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_008',   name: 'Cable Curl',                    category: 'Machine',           bodyPart: 'Arms' },
  { id: 'arm_009',   name: 'Machine Curl',                  category: 'Machine',           bodyPart: 'Arms' },
  { id: 'arm_010',   name: 'Triceps Pushdown (Bar)',        category: 'Machine',           bodyPart: 'Arms' },
  { id: 'arm_011',   name: 'Triceps Pushdown (Rope)',       category: 'Machine',           bodyPart: 'Arms' },
  { id: 'arm_012',   name: 'Overhead Triceps Extension',    category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_013',   name: 'Skull Crushers',                category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_014',   name: 'Close-Grip Bench Press',        category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_015',   name: 'Triceps Dip',                   category: 'Weighted Bodyweight', bodyPart: 'Arms' },
  { id: 'arm_016',   name: 'Kickback',                      category: 'Dumbbell',          bodyPart: 'Arms' },
  { id: 'arm_017',   name: 'Wrist Curl',                    category: 'Barbell',           bodyPart: 'Arms' },
  { id: 'arm_018',   name: 'Reverse Wrist Curl',            category: 'Barbell',           bodyPart: 'Arms' },

  // ── LEGS ───────────────────────────────────
  { id: 'leg_001',   name: 'Squat',                         category: 'Barbell',           bodyPart: 'Legs' },
  { id: 'leg_002',   name: 'Front Squat',                   category: 'Barbell',           bodyPart: 'Legs' },
  { id: 'leg_003',   name: 'Hack Squat',                    category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_004',   name: 'Bulgarian Split Squat',         category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_005',   name: 'Goblet Squat',                  category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_006',   name: 'Leg Press',                     category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_007',   name: 'Leg Extension',                 category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_008',   name: 'Seated Leg Curl',               category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_009',   name: 'Lying Leg Curl',                category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_010',   name: 'Romanian Deadlift (Dumbbell)',  category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_011',   name: 'Stiff-Leg Deadlift',            category: 'Barbell',           bodyPart: 'Legs' },
  { id: 'leg_012',   name: 'Walking Lunges',                category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_013',   name: 'Reverse Lunge',                 category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_014',   name: 'Calf Raises (Standing)',        category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_015',   name: 'Calf Raises (Seated)',          category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_016',   name: 'Donkey Calf Raise',             category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_017',   name: 'Hip Thrust',                    category: 'Barbell',           bodyPart: 'Legs' },
  { id: 'leg_018',   name: 'Glute Kickback (Cable)',        category: 'Machine',           bodyPart: 'Legs' },
  { id: 'leg_019',   name: 'Sumo Squat',                    category: 'Barbell',           bodyPart: 'Legs' },
  { id: 'leg_020',   name: 'Step-up',                       category: 'Dumbbell',          bodyPart: 'Legs' },
  { id: 'leg_021',   name: 'Nordic Curl',                   category: 'Weighted Bodyweight', bodyPart: 'Legs' },
  { id: 'leg_022',   name: 'Sissy Squat',                   category: 'Weighted Bodyweight', bodyPart: 'Legs' },

  // ── CORE ───────────────────────────────────
  { id: 'core_001',  name: 'Ab Wheel',                      category: 'Reps Only',         bodyPart: 'Core' },
  { id: 'core_002',  name: 'Plank',                         category: 'Duration',          bodyPart: 'Core' },
  { id: 'core_003',  name: 'Side Plank',                    category: 'Duration',          bodyPart: 'Core' },
  { id: 'core_004',  name: 'Crunch',                        category: 'Reps Only',         bodyPart: 'Core' },
  { id: 'core_005',  name: 'Bicycle Crunch',                category: 'Reps Only',         bodyPart: 'Core' },
  { id: 'core_006',  name: 'Sit-up',                        category: 'Reps Only',         bodyPart: 'Core' },
  { id: 'core_007',  name: 'Hanging Leg Raise',             category: 'Weighted Bodyweight', bodyPart: 'Core' },
  { id: 'core_008',  name: 'Hanging Knee Raise',            category: 'Weighted Bodyweight', bodyPart: 'Core' },
  { id: 'core_009',  name: 'Cable Crunch',                  category: 'Machine',           bodyPart: 'Core' },
  { id: 'core_010',  name: 'Decline Sit-up',                category: 'Weighted Bodyweight', bodyPart: 'Core' },
  { id: 'core_011',  name: 'Russian Twist',                 category: 'Dumbbell',          bodyPart: 'Core' },
  { id: 'core_012',  name: 'Pallof Press',                  category: 'Machine',           bodyPart: 'Core' },
  { id: 'core_013',  name: 'Woodchop',                      category: 'Machine',           bodyPart: 'Core' },
  { id: 'core_014',  name: 'Toe-to-Bar',                    category: 'Weighted Bodyweight', bodyPart: 'Core' },
  { id: 'core_015',  name: 'Dragon Flag',                   category: 'Weighted Bodyweight', bodyPart: 'Core' },
  { id: 'core_016',  name: 'L-Sit',                         category: 'Duration',          bodyPart: 'Core' },
  { id: 'core_017',  name: 'Dead Bug',                      category: 'Reps Only',         bodyPart: 'Core' },
  { id: 'core_018',  name: 'Hollow Body Hold',              category: 'Duration',          bodyPart: 'Core' },
  { id: 'core_019',  name: 'Landmine Rotation',             category: 'Barbell',           bodyPart: 'Core' },
  { id: 'core_020',  name: 'Ab Machine Crunch',             category: 'Machine',           bodyPart: 'Core' },

  // ── OLYMPIC ────────────────────────────────
  { id: 'oly_001',   name: 'Power Clean',                   category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_002',   name: 'Clean & Jerk',                  category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_003',   name: 'Snatch',                        category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_004',   name: 'Hang Clean',                    category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_005',   name: 'Push Press',                    category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_006',   name: 'Push Jerk',                     category: 'Barbell',           bodyPart: 'Olympic' },
  { id: 'oly_007',   name: 'Hang Snatch',                   category: 'Barbell',           bodyPart: 'Olympic' },

  // ── FULL BODY ──────────────────────────────
  { id: 'fb_001',    name: 'Kettlebell Swing',              category: 'Other',             bodyPart: 'Full Body' },
  { id: 'fb_002',    name: 'Kettlebell Turkish Get-up',     category: 'Other',             bodyPart: 'Full Body' },
  { id: 'fb_003',    name: 'Battle Ropes',                  category: 'Cardio',            bodyPart: 'Full Body' },
  { id: 'fb_004',    name: 'Burpee',                        category: 'Reps Only',         bodyPart: 'Full Body' },
  { id: 'fb_005',    name: 'Ball Slams',                    category: 'Other',             bodyPart: 'Full Body' },
  { id: 'fb_006',    name: 'Farmer\'s Walk',                category: 'Dumbbell',          bodyPart: 'Full Body' },
  { id: 'fb_007',    name: 'Sandbag Carry',                 category: 'Other',             bodyPart: 'Full Body' },
  { id: 'fb_008',    name: 'Sled Push',                     category: 'Other',             bodyPart: 'Full Body' },
  { id: 'fb_009',    name: 'Thrusters',                     category: 'Barbell',           bodyPart: 'Full Body' },
  { id: 'fb_010',    name: 'Wall Ball',                     category: 'Other',             bodyPart: 'Full Body' },

  // ── CARDIO ─────────────────────────────────
  { id: 'card_001',  name: 'Running (Treadmill)',           category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_002',  name: 'Running (Outdoor)',             category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_003',  name: 'Cycling (Stationary)',         category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_004',  name: 'Cycling (Outdoor)',            category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_005',  name: 'Rowing Machine',               category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_006',  name: 'Elliptical Trainer',           category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_007',  name: 'Stair Climber',                category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_008',  name: 'Jump Rope',                    category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_009',  name: 'Aerobics',                     category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_010',  name: 'Swimming',                     category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_011',  name: 'Assault Bike',                 category: 'Cardio',            bodyPart: 'Cardio' },
  { id: 'card_012',  name: 'Box Jump',                     category: 'Reps Only',         bodyPart: 'Cardio' },
  { id: 'card_013',  name: 'Jumping Jack',                 category: 'Reps Only',         bodyPart: 'Cardio' },
  { id: 'card_014',  name: 'Mountain Climber',             category: 'Reps Only',         bodyPart: 'Cardio' },
  { id: 'card_015',  name: 'Sprint Intervals',             category: 'Cardio',            bodyPart: 'Cardio' },
];
